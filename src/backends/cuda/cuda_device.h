...
public:
    ...
    [[nodiscard]] handle_ty create_texture(Image *image, const TextureViewCreation &texture_view, const TextureSampler& sampler) noexcept override { return 0; }
    [[nodiscard]] handle_ty create_texture(uint32_t width, uint32_t height, uint32_t depth, PixelStorage pixel_storage,
                                           ...
                                           uint4 default_color, const void *data) noexcept override { return 0; }
